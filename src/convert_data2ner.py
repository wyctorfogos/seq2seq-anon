...
TEMPLATES = [
    ...
    "Prezado(a) {name}, sou {name2}, advogado(a) inscrito(a) na {oab}. Escrevo sobre o débito pendente referente ao contrato nº {number} . Por favor, peço que entre em contato o mais breve possível para regularizarmos a situação. Caso contrário, tomaremos as medidas judiciais cabíveis. Agradeço a atenção."
]
