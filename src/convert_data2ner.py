...
tokenizer_name = "pierreguillou/ner-bert-large-cased-pt-lenerbr" # "celiudos/legal-bert-lgpd" # "pierreguillou/ner-bert-large-cased-pt-lenerbr" # "neuralmind/bert-base-portuguese-cased"
...
TEMPLATES = [
    "O cliente {name} {cpf} mora em {street}, {number}, {city}/{state}. Telefone: {phone}.",
    ...
    "O responsável {name3} (matrícula {user_id}) informou que o endereço {street3}, {number3}, CEP {cep}. é válido.",
...
def gen_data_row():
    ...
    data = {
        ...
        "cpf": "CPF:"+fake.cpf(), "cnpj": fake.cnpj(), "rg": fake.rg(),
        "email": fake.email(),
        ...
        "oab": fake.estado_sigla() +" "+ str(random.randint(100000,999999)),
