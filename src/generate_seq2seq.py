...
def gen_row():
    data = {
        ...
        "birth": fake.date_of_birth(minimum_age=1, maximum_age=90).strftime("%d/%m/%Y"),
        "date": fake.date_of_birth(minimum_age=1, maximum_age=90).strftime("%d/%m/%Y"),
