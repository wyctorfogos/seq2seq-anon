...
if __name__ == "__main__":
    model_dir = "/home/tjes/PROJETOS/seq2seq-anon/bert-ner-model" #"./ner-anon-model/checkpoint-10000" # "celiudos/legal-bert-lgpd"
    ...
    with open(inference_final_results, "w", encoding="utf8") as fout:
        for original_text in read_inputs("./data/to_test/sentences2test.txt"):
            pipeline_response = pipeline(text=original_text)
            fout.write(json.dumps(pipeline_response, ensure_ascii=False) + "\n")
